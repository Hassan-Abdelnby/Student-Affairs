...
if (empty($_POST['firstname'])) {
	...
	$query = "UPDATE info_student SET firstname='$upfirstname', first_mark='$upfirst', second_mark='$upsecond', third_mark='$upthird', fourth_mark='$upfourth', fifth_mark='$upfifth', sixth_mark='$upsixth' WHERE id='$id'";
		...
		<div class="container">
			<form action="" method="post" enctype="multipart/form-data" class="form">
				...
				<div class="form-group">
					...
					<div class="input-box">
						<input type="text" name="firstname" class="box" placeholder="frist name" value="<?php echo $upfirstname; ?>" readonly>
					</div>
				</div>
				...
				<div class="form-group">
					<label for="Author">Three subject</label>
					<div class="input-box">
						<input type="text" name="third" class="box" placeholder="Three subject" value="<?php echo $upthird; ?>" required>
					</div>
				</div>
				...
				<div class="button-container">
					<button name="update" class="btn" class="button-container" data-toggle="modal">added</button>
				</div>
				<br>
			</form>
		</div>
